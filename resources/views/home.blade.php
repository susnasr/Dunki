        ...
        <div class="e-commerce-dashboard">
            ...
            <div class="row g-4 mb-4">
                <div class="col-lg-6 h-100">
                    <div class="card mb-0">
                        <div class="card-header d-flex flex-wrap align-items-center justify-content-between gap-3">
                            <div class="flex-grow-1">
                                <h5 class="mb-1">application submissions or task completions over time</h5>
                ...
                <div class="col-lg-3 h-100">
                    <div class="card mb-0">
                        <div class="card-header">
                            <h5 class="card-title mb-0">student satisfaction or application approval rates</h5>
                        </div>
                        <div class="card-body">
                ...
                <div class="col-lg-3 h-100">
                    <div class="card">
                        <div class="card-header d-flex flex-wrap align-items-center justify-content-between gap-3">
                            <h5 class="card-title mb-0">total fees collected or applications processed</h5>
                    ...
                    <div class="card mb-0">
                        <div class="card-header">
                            <h5 class="mb-0">New Students Joined</h5>
                        </div>
                        <div class="card-body">
                            <h4 class="fw-semibold d-flex align-items-center gap-3 mb-4">
            ...
            <div class="row g-4">
                ...
                <div class="col-lg-4 col-xl-3">
                    <div class="card mb-0">
                        <div class="card-header d-flex flex-wrap align-items-center justify-content-between gap-3">
                            <h5 class="card-title mb-0 flex-grow-1">top destination countries or universities</h5>
