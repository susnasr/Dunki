...
<body>
    ...
    <div class="hstack flex-wrap gap-3 mb-5">
      <div class="flex-grow-1">
        <h4 class="mb-1 fw-semibold">Project List</h4>
        <nav>
      ...
      <div class="d-flex my-xl-auto align-items-center flex-wrap flex-shrink-0">
        <a href="apps-projects-create.html" class="btn btn-sm btn-light-primary">
          Add Project
        </a>
      </div>
    </div>
    ...
    <!-- Product List init -->
    <script src="assets/js/apps/ecommerce/apps-projects-list.init.js"></script>
