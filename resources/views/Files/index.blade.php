        ...
        <div class="app-container">
            ...
            <div class="hstack flex-wrap gap-3 mb-5">
                <div class="flex-grow-1">
                    <h4 class="mb-1 fw-semibold">My Uploaded Documents</h4>
                    <nav>
                ...
                <div class="d-flex my-xl-auto align-items-center flex-wrap flex-shrink-0">
                    <button class="btn btn-sm btn-light-primary" data-bs-toggle="modal" data-bs-target="#uploadModal">
                        ...
                        <div class="card">
                            ...
                            <div class="d-flex align-items-center gap-3 p-3 border-bottom border-block-end-dashed">
                                <div class="avatar-item">
                                    <img class="img-fluid avatar-lg rounded-2"
                                         src="{{ asset('storage/' . (auth()->user()->profile_pic ?? 'default.png')) }}"
                                         alt="avatar image">
                                </div>
                                <div>
                            ...
                            <div class="card-body p-3">
                                <ul class="list-group list-borderless">
                                    <li class="list-group-item px-3 py-2 active">All Documents</li>
                                    <li class="list-group-item px-3 py-2">Recent Uploads</li>
                                    <li class="list-group-item px-3 py-2">Verified</li>
                                    <li class="list-group-item px-3 py-2">Rejected</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="row g-4">
                                @forelse($files as $file)
                                    <div class="col-sm-6 col-lg-4 col-xl-3">
                                        <div class="card bg-light border-light shadow-none card-h-100">
                                            <div class="card-body text-center">
                                                <!-- ✅ File icon based on type -->
                                                @php
                                                    $iconClass = match($file->file_type) {
                                                        'passport' => 'bi-passport',
                                                        'transcript' => 'bi-journal-text',
                                                        'sop' => 'bi-file-earmark-text',
                                                        'lor' => 'bi-file-earmark-person',
                                                        'ielts' => 'bi-translate',
                                                        'financial_proof' => 'bi-cash-stack',
                                                        'photo' => 'bi-image',
                                                        'cv' => 'bi-person-badge',
                                                ...
                                                <i class="bi {{ $iconClass }} fs-32 mb-3 text-primary"></i>
                                                <h6 class="fw-semibold text-truncate mb-1">{{ $file->original_name }}</h6>
                                                ...
                                                <!-- ✅ Status badge -->
                                                <span class="badge
                                                @if($file->status === 'verified') bg-success
                                                @elseif($file->status === 'rejected') bg-danger
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                ...
                                <select name="file_type" class="form-select" required>
                                    ...
                                    <option value="ielts">IELTS/TOEFL Result</option>
                            ...
                            <div class="mb-3">
                                ...
                                <small class="text-muted">
                                    Allowed: JPG, PNG, PDF, DOCX, XLSX (max 5MB)
                                </small>
                            </div>
