...
<body>
    ...
    <div class="hstack flex-wrap gap-3 mb-5">
      <div class="flex-grow-1">
        <h4 class="mb-1 fw-semibold">File Manager</h4>
        <nav>
      ...
      <div class="d-flex my-xl-auto align-items-center flex-wrap flex-shrink-0">
        <a href="javascript:void(0)" class="btn btn-sm btn-light-primary" data-bs-toggle="modal" data-bs-target="#uploadModal">
          Add File
        </a>
      </div>
    </div>
                    ...
                    <div class="mt-auto card-footer">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div class="flex-grow-1 ms-3 overflow-hidden">
                                ...
                                <span class="text-muted fs-12 d-block text-truncate"><b>59.5</b>GB used of <b>119</b>GB</span>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card-header flex-wrap hstack justify-content-between gap-2">
                    ...
                    <div class="d-flex align-items-center gap-2">
                        <div class="btn-group" role="group">
                            ...
                            <div class="btn-group">
                                <button type="button" class="btn btn-primary dropdown-toggle" id="uploadGroupDropdown" data-bs-toggle="dropdown" aria-expanded="false" aria-label="File options"></button>
                                <div class="dropdown-menu dropdown-menu-end" aria-labelledby="uploadGroupDropdown">
                                    <a class="dropdown-item" href="#!" data-bs-toggle="modal" data-bs-target="#create-file">
                                        <i class="bi-file-plus"></i> New file
                                    </a>
                                    <a class="dropdown-item" href="#!" data-bs-toggle="modal" data-bs-target="#create-folder">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-6 col-lg-4 col-xl-3 delete-element">
                            <div class="card bg-light bg-opacity-20 border border-light shadow-none card-h-100">
                                ...
                                <div class="position-absolute start-0 p-3">
                                    <div class="custom-toggle text-warning fs-12 d-flex align-items-center cursor-pointer" role="button" aria-label="Toggle Favorite">
                                ...
                                <div class="position-absolute end-0 p-2">
                                    ...
                                    <div class="dropdown">
                                        <button type="button" class="btn btn-text-light icon-btn-sm rounded-circle text-muted" data-bs-toggle="dropdown" aria-expanded="false" aria-label="More options">
                                            <i class="bi-three-dots-vertical"></i>
                                        </button>
                                        <div class="dropdown-menu dropdown-menu-end min-w-176px">
                                            <a class="dropdown-item" href="#!" data-bs-toggle="modal" data-bs-target="#shareFileModal"><i class="bi-share"></i> Share File</a>
                                            <a class="dropdown-item" href="#!"><i class="bi-folder-plus"></i> Move to Folder</a>
                                            <a class="dropdown-item" href="#!"><i class="bi-pencil"></i> Rename File</a>
                                            <a class="dropdown-item" href="#!"><i class="bi-download"></i> Download File</a>
                                            <div class="dropdown-divider"></div>
                                            <a class="dropdown-item delete-item delete-btn" href="#!"><i class="bi-trash"></i> Delete File</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="card-body d-flex justify-content-center align-items-center p-0 overflow-hidden min-h-112px">
                        ...
                        <div class="col-12 col-sm-6 col-lg-4 col-xl-3 delete-element">
                            <div class="card bg-light bg-opacity-20 border border-light shadow-none card-h-100">
                                <!-- Add Favorite -->
                                <div class="position-absolute start-0 p-3">
                                    <div class="custom-toggle text-warning fs-12 d-flex align-items-center cursor-pointer active" role="button" aria-label="Toggle Favorite" aria-pressed="true">
                                        <span class="icon-on" aria-hidden="true"><i class="bi bi-star-fill"></i></span>
                                        <span class="icon-off" aria-hidden="true"><i class="bi bi-star"></i></span>
                                    </div>
                                </div>
                                ...
                                <div class="card-body p-4">
                                    <div class="d-flex align-items-center gap-3">
                                        ...
                                        <div class="dropdown ms-auto">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end min-w-176px">
                                                <a class="dropdown-item" href="#!" data-bs-toggle="modal" data-bs-target="#shareFileModal"><i class="bi-share"></i> Share Folder</a>
                                                <a class="dropdown-item" href="#!"><i class="bi-folder-plus"></i> Move Folder</a>
                                                <a class="dropdown-item" href="#!"><i class="bi-star"></i> Add to Favorites</a>
                                                <a class="dropdown-item" href="#!"><i class="bi-pencil"></i> Rename Folder</a>
                                                <div class="dropdown-divider"></div>
                                                <a class="dropdown-item delete-item delete-btn" href="#!"><i class="bi-trash"></i> Delete Folder</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="modal-body">
                    <form>
                        <div class="card bg-light position-relative">
                            <div class="card-body p-12 border border-light rounded d-flex flex-column align-items-center gap-2 text-center z-1">
                                <img class="mx-auto img-fluid w-200px" src="assets/images/upload-file.png" alt="File Upload">
                                <h6 class="fw-semibold mb-0 mt-2">Drag and drop your file here</h6>
                                <p class="text-muted fs-sm mb-0">or</p>
                                <span class="btn btn-white btn-light-primary btn-sm fw-medium d-flex align-items-center gap-2">
                                    <i class="ri-upload-2-line fs-14"></i>
                                    Browse files
                                </span>
                            </div>
                            <input class="form-control h-100 w-100 position-absolute z-2 opacity-0" type="file" id="fileInput0">
                        </div>
                    </form>
                </div>
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control" value="https://example.com/folder/my-documents" id="shareLink" readonly>
    ...
    <!-- File Manager init -->
    <script src="assets/js/apps/file-manager/apps-file-manager.init.js"></script>
