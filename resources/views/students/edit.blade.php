...
<head>
    ...
    <meta charset="utf-8">
    <title>Profile edit | Dunki</title>
        ...
        <div class="nav-header">
            ...
            <div class="header-left hstack gap-3">
                ...
                <div class="app-sidebar-logo app-horizontal-logo justify-content-center align-items-center">
                    <a href="index.html">
                        <img height="35" class="app-sidebar-logo-default" alt="Logo" loading="lazy" src="assets/images/light-logo.png">
                                    ...
                                    <div class="d-flex">
                                        <div class="flex-shrink-0 me-3">
                                            <div class="avatar-item avatar">
                                                <img class="img-fluid avatar" src="assets/images/avatar/avatar-9.jpg" alt="avatar image">
                                            </div>
                                        </div>
                                        <div class="flex-grow-1">
                                ...
                                <li class="list-group-item list-group-item-action border-start-0 border-end-0">
                                    <div class="d-flex">
                                        <div class="flex-shrink-0 me-3 position-relative">
                                            <div class="avatar-item avatar">
                                                <img class="img-fluid avatar" src="assets/images/avatar/avatar-6.jpg" alt="avatar image">
                                            </div>
              ...
              <span class="position-relative">
                ...
                <span class="d-none d-xl-block fs-12 text-start text-muted">CEO</span>
                    ...
                    <div class="dropdown-menu dropdown-menu-end header-language-scrollable" aria-labelledby="accountNavbarDropdown">
                        ...
                        <a class="dropdown-item" href="https://codebucks.in/herozi/auth-signin.html">Sign out</a>
                    </div>
                </div>
            </div>
        </div>
...
<main class="app-wrapper">
    <div class="app-container">
        ...
        <div class="hstack flex-wrap gap-3 mb-5">
            <div class="flex-grow-1">
                <h4 class="mb-1 fw-semibold">Profile</h4>
                <nav>
            ...
            <div class="d-flex my-xl-auto align-items-center flex-wrap flex-shrink-0">
                <a href="javascript:void(0)" class="btn btn-sm btn-light-primary" data-bs-toggle="modal" data-bs-target="#shareModal">
                    Share
                </a>
            </div>
        </div>
            ...
            <div class="card-body pb-0">
                    ...
                    <div class="position-relative w-max">
                        <div class="d-flex align-items-center flex-wrap gap-3" data-uploader>
                            <div class="avatar-item avatar-xl">
                                <img class="img-fluid avatar-xl" alt="avatar image" data-default-src="assets/images/avatar/avatar-1.jpg" data-action="avatar-image">
                            </div>
                ...
                <ul class="nav nav-tabs-bordered border-0 justify-content-center mt-5" role="tablist">
                    <li class="nav-item" role="presentation">
                        <a class="nav-link active" href="pages-profile-edit-overview.html">Basic Information</a>
                    </li>
                    <li class="nav-item" role="presentation">
                        <a class="nav-link" href="pages-profile-edit-security.html">Security</a>
                    </li>
                    <li class="nav-item" role="presentation">
                        <a class="nav-link" href="pages-profile-edit-billing-plans.html">Billing & Plans</a>
                    </li>
                    <li class="nav-item" role="presentation">
                        <a class="nav-link" href="pages-profile-edit-notifications.html">Notifications</a>
                    </li>
                    <li class="nav-item" role="presentation">
                        <a class="nav-link" href="pages-profile-edit-connections.html">Connections</a>
                    </li>
                </ul>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex align-items-center flex-wrap gap-3">
                            <img class="img-fluid rounded-2 w-100px h-100px" src="assets/images/avatar/avatar-1.jpg" alt="avatar image">
                            <div>
...
<!-- Profile init -->
<script src="assets/js/pages/pages-profile.init.js"></script>
