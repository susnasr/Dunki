...
<body>
            ...
            <div class="hstack justify-content-between gap-3">
                ...
                <ul class="nav nav-pills" role="tablist">
                    <li class="nav-item" role="presentation">
                        <a class="nav-link btn icon-btn-sm active" data-bs-toggle="tab" href="#demo-tab-5_home" role="tab" aria-selected="true" tabindex="-1">
                            <i class="ri-list-check"></i>
                        </a>
                    </li>
                    <li class="nav-item" role="presentation">
                        <a class="nav-link btn icon-btn-sm" data-bs-toggle="tab" href="#demo-tab-5_profile" role="tab" aria-selected="false">
                    ...
                    <div class="card h-100 mb-0 shadow-sm border-light rounded">
                        <div class="card-body p-4">
                            ...
                            <div class="dropdown float-end">
                                <a href="#!" class="btn icon-btn-sm btn-text-primary" data-bs-toggle="dropdown" aria-expanded="false">
                                    <i class="ri ri-more-2-fill fs-14"></i>
                                </a>
                                <ul class="dropdown-menu p-3">
                                    <li>
                                        <a class="dropdown-item" href="#!" data-bs-toggle="modal" data-bs-target="#edit-student-profile">Edit</a>
                                    </li>
                                    <li>
                                        <a href="apps-course-student-details.html" class="dropdown-item">View</a>
                                    </li>
                                    <li>
                            ...
                            <div class="position-relative w-max mx-auto mb-3">
                                <div class="avatar-item avatar-xl overflow-hidden">
                                    <img class="img-fluid" src="assets/images/avatar/avatar-2.jpg" alt="avatar image">
                                </div>
                                <span class="position-absolute border-2 border border-white h-12px w-12px rounded-circle bg-success end-0 bottom-0 m-1" title="Student is online"></span>
                            </div>
                        ...
                        <div class="card-footer d-flex justify-content-center">
                            <a href="apps-course-student-details.html" class="btn btn-sm btn-light-primary text-decoration-none">
                                View Profile
                            </a>
                        </div>
                    </div>
                ...
                <div class="col-12 col-md-6 col-lg-4 delete-element">
                    <div class="card h-100 mb-0 shadow-sm border-light rounded">
                        <div class="card-body p-4">
                            ...
                            <div class="position-relative w-max mx-auto mb-3">
                                <div class="avatar-item avatar-xl overflow-hidden">
                                    <img class="img-fluid" src="assets/images/avatar/avatar-4.jpg" alt="avatar image">
                                </div>
                                <span class="position-absolute border-2 border border-white h-12px w-12px rounded-circle bg-danger end-0 bottom-0 m-1" title="Student is online"></span>
                            </div>
                ...
                <div class="col-12 col-md-6 col-lg-4 delete-element">
                    <div class="card h-100 mb-0 shadow-sm border-light rounded">
                        <div class="card-body p-4">
                            ...
                            <div class="position-relative w-max mx-auto mb-3">
                                <div class="avatar-item avatar-xl overflow-hidden">
                                    <img class="img-fluid" src="assets/images/avatar/avatar-3.jpg" alt="avatar image">
                                </div>
                                <span class="position-absolute border-2 border border-white h-12px w-12px rounded-circle bg-success end-0 bottom-0 m-1" title="Student is online"></span>
                            </div>
                ...
                <div class="col-12 col-md-6 col-lg-4 delete-element">
                    <div class="card h-100 mb-0 shadow-sm border-light rounded">
                        <div class="card-body p-4">
                            ...
                            <div class="position-relative w-max mx-auto mb-3">
                                <div class="avatar-item avatar-xl overflow-hidden">
                                    <img class="img-fluid" src="assets/images/avatar/avatar-7.jpg" alt="avatar image">
                                </div>
                                <span class="position-absolute border-2 border border-white h-12px w-12px rounded-circle bg-danger end-0 bottom-0 m-1" title="Student is online"></span>
                            </div>
                ...
                <div class="col-12 col-md-6 col-lg-4 delete-element">
                    <div class="card h-100 mb-0 shadow-sm border-light rounded">
                        <div class="card-body p-4">
                            ...
                            <div class="position-relative w-max mx-auto mb-3">
                                <div class="avatar-item avatar-xl overflow-hidden">
                                    <img class="img-fluid" src="assets/images/avatar/avatar-6.jpg" alt="avatar image">
                                </div>
                                <span class="position-absolute border-2 border border-white h-12px w-12px rounded-circle bg-danger end-0 bottom-0 m-1" title="Student is online"></span>
                            </div>
                ...
                <div class="col-12 col-md-6 col-lg-4 delete-element">
                    <div class="card h-100 mb-0 shadow-sm border-light rounded">
                        <div class="card-body p-4">
                            ...
                            <div class="position-relative w-max mx-auto mb-3">
                                <div class="avatar-item avatar-xl overflow-hidden">
                                    <img class="img-fluid" src="assets/images/avatar/avatar-9.jpg" alt="avatar image">
                                </div>
                                <span class="position-absolute border-2 border border-white h-12px w-12px rounded-circle bg-success end-0 bottom-0 m-1" title="Student is online"></span>
                            </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="d-flex align-items-center flex-wrap gap-3 mb-5">
                        <div class="avatar-item avatar-xl overflow-hidden">
                            <img class="img-fluid" alt="avatar image" src="assets/images/avatar/avatar-1.jpg">
                        </div>
                        <div>
    ...
    <!-- Student List init -->
    <script src="assets/js/apps/course/apps-student-list.init.js"></script>
