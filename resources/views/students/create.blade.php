...
<head>
    ...
    <link rel="stylesheet" href="assets/libs/%40yaireo/tagify/tagify.css">
...
<body>
    ...
    <div class="hstack flex-wrap gap-3 mb-5">
      <div class="flex-grow-1">
        <h4 class="mb-1 fw-semibold">Add Student</h4>
        <nav>
            ...
            <form class="row">
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input class="form-control" name="first name" id="fname" type="text" placeholder="Enter your first name">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="mb-3">
                        <label class="form-label" for="lname">Last Name:</label>
                        <input class="form-control" name="last name" id="lname" type="text" placeholder="Enter your last name">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="mb-3">
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="date-of-birth" placeholder="Enter your date of birth">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="mb-3">
            ...
            <form class="row">
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            <input type="password" id="password" class="form-control" value="123456" name="password" placeholder="Enter your password" data-visible="false">
                            <a class="input-group-text bg-transparent toggle-password" href="#!" data-target="password">
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            <input type="password" id="confirm-password" class="form-control" value="123456" name="password" placeholder="Enter your confirm password" data-visible="false">
                            <a class="input-group-text bg-transparent toggle-password" href="#!" data-target="password">
                                <i class="text-muted toggle-icon ri-eye-off-line"></i>
                            </a>
                        </div>
                ...
                <div class="row rows-cols-xxl-5">
                    <div class="col-12 col-md-3">
                        <div class="mb-3">
                            ...
                            <input type="text" name="social links" class="form-control" placeholder="Link your twitter">
                        </div>
                    </div>
                    <div class="col-12 col-md-3">
                        <div class="mb-3">
                            <label class="form-label">Github</label>
                            <input type="text" name="social links" class="form-control" placeholder="Link your github">
                        </div>
                    </div>
                    <div class="col-12 col-md-3">
                        <div class="mb-3">
                            <label class="form-label">Linked In</label>
                            <input type="text" name="social links" class="form-control" placeholder="Link your linked in">
                        </div>
                    </div>
                    <div class="col-12 col-md-3">
                        <div class="mb-3">
                            <label class="form-label">Dribbble</label>
                            <input type="text" name="social links" class="form-control" placeholder="Link your dribbble">
                        </div>
                    </div>
                </div>
            </form>
    ...
    <!-- Tagify js -->
    <script src="assets/libs/%40yaireo/tagify/tagify.js"></script>
    ...
    <!-- Blog js -->
    <script src="assets/js/apps/course/apps-course-student-add.init.js"></script>
